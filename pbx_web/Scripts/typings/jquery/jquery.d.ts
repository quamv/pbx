...
interface JQueryStatic {
     ...
     * @param queue_name A string containing the name of the queue. Defaults to fx, the standard effects queue.
     */
    dequeue(element: Element, queue_name?: string): void;
     ...
     * @param queue_name A string containing the name of the queue. Defaults to fx, the standard effects queue.
     */
    queue(element: Element, queue_name?: string): any[];
    /**
     ...
     */
    queue(element: Element, queue_name: string, newQueue: Function[]): JQuery;
    /**
     * Manipulate the queue of functions to be executed on the matched element.
     *
     ...
     */
    queue(element: Element, queue_name: string, callback: Function): JQuery;
...
interface JQuery {
     ...
     * @param queue_name A string containing the name of the queue. Defaults to fx, the standard effects queue.
     */
    clearQueue(queue_name?: string): JQuery;
     ...
     * @param queue_name A string containing the name of the queue. Defaults to fx, the standard effects queue.
     */
    dequeue(queue_name?: string): JQuery;
     ...
     * @param queue_name A string containing the name of the queue. Defaults to fx, the standard effects queue.
     */
    delay(duration: number, queue_name?: string): JQuery;
    ...
    */
     ...
     * @param newQueue An array of functions to replace the current queue contents.
     */
    queue(queue_name: string, newQueue: Function[]): JQuery;
    /**
     * Manipulate the queue of functions to be executed, once for each matched element.
     * 
     * @param queue_name A string containing the name of the queue. Defaults to fx, the standard effects queue.
     * @param callback The new function to add to the queue, with a function to call that will dequeue the next item.
     */
    queue(queue_name: string, callback: Function): JQuery;
}
